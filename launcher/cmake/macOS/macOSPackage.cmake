set(SOLARUSLAUNCHER_CPACK_PRETTY_DMG_ENABLED ON CACHE BOOL "Enable DMG customization with AppleScript")

get_target_property(SOLARUSLAUNCHER_BUNDLE_BASENAME ${PROJECT_NAME} OUTPUT_NAME)

if(SOLARUSLAUNCHER_CPACK_PRETTY_DMG_ENABLED)
...
set(CPACK_PACKAGE_NAME "${SOLARUSLAUNCHER_BUNDLE_BASENAME}")
set(CPACK_PACKAGE_FILE_NAME "${SOLARUSLAUNCHER_BUNDLE_BASENAME}") # CPack can't find if not named like this.
...
set(CPACK_BUNDLE_NAME "${SOLARUSLAUNCHER_BUNDLE_BASENAME}")
set(CPACK_DMG_VOLUME_NAME "${SOLARUSLAUNCHER_DISPLAY_NAME} Installer v${PROJECT_VERSION}")
