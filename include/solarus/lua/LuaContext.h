...
class LuaContext {
  ...
  public:
    ...
    static FunctionExportedToLua
      ...
      hero_api_get_walking_on_grass_sound,
      hero_api_set_walking_on_grass_sound,
      hero_api_get_walking_on_water_sound,
      hero_api_set_walking_on_water_sound,
      ...
      stairs_api_is_inner,
      stairs_api_get_subtype,
      stairs_api_set_subtype,
      shop_treasure_api_get_treasure,
      shop_treasure_api_get_price,
      shop_treasure_api_get_price_font,
      shop_treasure_api_get_dialog_id,
