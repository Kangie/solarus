...
class LuaContext {
  ...
  public:
    ...
    static FunctionExportedToLua
      ...
      hero_api_get_falling_sound_id,
      hero_api_set_falling_sound_id,
      hero_api_get_respawn_sound_id,
      hero_api_set_respawn_sound_id,
      ...
      chest_api_get_cannot_open_sound_id,
      chest_api_set_cannot_open_sound_id,
      chest_api_get_opening_sound_id,
      chest_api_set_opening_sound_id,
      block_api_reset,
      ...
      block_api_get_moving_sound_id,
      block_api_set_moving_sound_id,
      block_api_get_falling_sound_id,
      block_api_set_falling_sound_id,
      block_api_get_sinking_sound_id,
      block_api_set_sinking_sound_id,
      ...
      door_api_get_opening_sound_id,
      door_api_set_opening_sound_id,
      door_api_get_closing_sound_id,
      door_api_set_closing_sound_id,
      door_api_get_unlocking_sound_id,
      door_api_set_unlocking_sound_id,
      door_api_get_cannot_open_sound_id,
      door_api_set_cannot_open_sound_id,
