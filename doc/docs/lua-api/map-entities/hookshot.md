...
A hookshot [map entity](./index.md) is used to implement the [hero](./hero.md)'s hookshot state.
...
A hookshot is a particular [map entity](./index.md). Therefore, it inherits all events from the type map entity.
