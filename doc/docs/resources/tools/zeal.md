...
[Zeal](https://zealdocs.org) is an offline documentation browser for software developers. It is the free and open-source equivalent for macOS' [Dash](https://kapeli.com/dash). It allows you to download, explore and search into a large set of technical documentations.
