...
---@param entity_sprite sprite|nil|nil
---@param other_entity_sprite sprite|nil|nil
---@return boolean
function m:overlaps(other_entity,collision_mode,entity_sprite,other_entity_sprite) end
